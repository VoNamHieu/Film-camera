...
struct FilmPresets {
    ...
    static let polaroid600 = FilterPreset(
        ...
        instantFilm: InstantFilmConfig(
            enabled: true,
            chemicalFade: ChemicalFade(enabled: true, edgeFade: 0.12, cornerDarkening: 0.08, unevenDevelopment: 0.05),
            frame: InstantFrame(enabled: true, type: "polaroid_600", borderColor: BorderColor(r: 250, g: 248, b: 245),
                borderWidth: BorderWidth(top: 0.06, left: 0.05, right: 0.05, bottom: 0.18), texture: "matte",
    ...
    static let instaxMini = FilterPreset(
        ...
        instantFilm: InstantFilmConfig(
            enabled: true,
            chemicalFade: ChemicalFade(enabled: true, edgeFade: 0.08, cornerDarkening: 0.05, unevenDevelopment: 0.03),
            frame: InstantFrame(enabled: true, type: "instax_mini", borderColor: BorderColor(r: 255, g: 255, b: 255),
                borderWidth: BorderWidth(top: 0.08, left: 0.04, right: 0.04, bottom: 0.15), texture: "glossy",
    ...
    static let polaroidSX70 = FilterPreset(
        ...
        instantFilm: InstantFilmConfig(
            enabled: true,
            chemicalFade: ChemicalFade(enabled: true, edgeFade: 0.15, cornerDarkening: 0.12, unevenDevelopment: 0.08),
            frame: InstantFrame(enabled: true, type: "polaroid_sx70", borderColor: BorderColor(r: 248, g: 245, b: 240),
                borderWidth: BorderWidth(top: 0.05, left: 0.05, right: 0.05, bottom: 0.16), texture: "matte",
    ...
    static let cineStill800T = FilterPreset(
        ...
        halation: HalationConfig(enabled: true, color: HalationColor(r: 255, g: 80, b: 40), intensity: 0.40, threshold: 0.65, radius: 28, softness: 0.88,
            colorGradient: HalationGradient(enabled: true, inner: HalationColor(r: 255, g: 100, b: 50), outer: HalationColor(r: 255, g: 50, b: 30))),
